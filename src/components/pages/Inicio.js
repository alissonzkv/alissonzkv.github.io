  ...
  return (
    <div className={styles.inicioContainer}>
      ...
      <div className={styles.card}>
        ...
        <h2 className={styles.subtitlecourses}>Courses</h2>
      </div>
      ...
      <div className={styles.teachingSection}>
        <div className={styles.teachingCards}>
          {[
            { 
              title: "Advanced Topics in Computer Networks (QXD048)", 
              Semester: "2023.1, 2018.1, 2017.1",
            ...
            { 
              title: "Cloud Computing (QXD079)", 
              Semester: "2023.1, 2021.1, 2016.1, 2015.1",
            ...
            { 
              title: "Computer Networks (QXD021)", 
              Semester: "2023.2, 2022.2, 2021.2, 2016.2, 2015.2, 2014.2",
            ...
            { 
              title: "Concurrent Software Development (QXD074)", 
              Semester: "2022.1, 2015.1, 2014.2",
            ...
            { 
              title: "Distributed Systems (QXD043)", 
              Semester: "2021.1",
            ...
            { 
              title: "Internet and TCP/IP Architecture (QXD086)", 
              Semester: "2023.1, 2022.1, 2016.1, 2015.1",
            ...
            { 
              title: "Mobile and Wireless Networks (QXD090)", 
              Semester: "2024.2, 2022.2, 2021.2, 2018.2, 2017.2",
            ...
            { 
              title: "Programming Fundamentals (QXD001)", 
              Semester: "2022.1, 2014.1",
            ...
            { 
              title: "Script Programming(QXD088)", 
              Semester: "2015.2",
            ...
            { 
              title: "Service Oriented Architecture (QXD050)", 
              Semester: "2015.2, 2014.1",
            ...
            { 
              title: "Windows Operating System Administration (QXD085)", 
              Semester: "2024.1",
            ...
            <div key={index} className={styles.card}>
              ...
              <div className={styles.semesterSection}>
                <p><strong>Semester:</strong> {disciplina.Semester}</p>
              </div>
